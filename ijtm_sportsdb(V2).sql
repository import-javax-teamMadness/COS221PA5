CREATE DATABASE  IF NOT EXISTS `ijtm_sportsdb` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
USE `ijtm_sportsdb`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: ijtm_sportsdb
-- ------------------------------------------------------
...
-- Dump completed on 2022-06-06 21:38:44
