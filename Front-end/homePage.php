...
<body>
  <main>
    <div class="homepage-flex-container">
      <div class="homepage-flex-container-tournamentInfo">
        <div class="box4" id="tournaments">
          <h2>
            Ongoing tournaments:
          </h2>
          <p id="tournamentList">
            Tournament Name (xx/xx/xxxx) <br><br>
            Tournament Name (xx/xx/xxxx) <br><br>
            Tournament Name (xx/xx/xxxx) <br><br>
            Tournament Name (xx/xx/xxxx) <br><br>
            Tournament Name (xx/xx/xxxx) <br><br>
            Tournament Name (xx/xx/xxxx)
          </p>
        </div>
        <div class="box5" id="tournamentInfo">
          <h2>
            Tournament information:
          </h2>
          <div class="homepage-flex-container-image-description">
            <div class="box7" id="image">
            </div>
            <div class="box8" id="description">
              <p id="courseDesc">
      ...
      <div class="homepage-flex-container-tournamentScoreboard">
        <div class="box6" id="scoreboard">
          <h2>
