...
--
-- Host: 127.0.0.1    Database: golf_sportsdb
-- ------------------------------------------------------
...
CREATE TABLE `event_stats` (
  ...
  CONSTRAINT `fk_es_event_id` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_action` (
  ...
  `aswing_id` int(11) NOT NULL,
  PRIMARY KEY (`event_state_id`,`hole_id`,`aswing_id`),
...
CREATE TABLE `golf_hole_winner` (
  ...
  PRIMARY KEY (`player_id`,`hole_id`,`event_id`),
  ...
  CONSTRAINT `fk_ghw_player_id` FOREIGN KEY (`player_id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_player` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_player_id` FOREIGN KEY (`id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_player_furthest_from_hole` (
  ...
  PRIMARY KEY (`player_id`,`event_state_id`),
  ...
  CONSTRAINT `fk_gpffh_player_id` FOREIGN KEY (`player_id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_player_swing` (
  ...
  CONSTRAINT `fk_gps_player_id` FOREIGN KEY (`id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_score_relation` (
  ...
  PRIMARY KEY (`player_id`,`score_card_id`),
  ...
  CONSTRAINT `fk_scr_player_id` FOREIGN KEY (`player_id`) REFERENCES `persons` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_scr_score_card_id` FOREIGN KEY (`score_card_id`) REFERENCES `golf_score_card` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `golf_sponsorship` (
  ...
  PRIMARY KEY (`sponser_id`,`sponsee_id`),
  KEY `fk_sponsee_id_idx` (`sponsee_id`),
  CONSTRAINT `fk_sponsee_id` FOREIGN KEY (`sponsee_id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_sponser_id` FOREIGN KEY (`sponser_id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `leading_player`
--

DROP TABLE IF EXISTS `leading_player`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `leading_player` (
  `player_id` int(11) NOT NULL,
  `event_state_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_lp_player_id` FOREIGN KEY (`player_id`) REFERENCES `persons` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `player_event_stats`
--
...
CREATE TABLE `player_event_stats` (
  ...
  CONSTRAINT `fk_pes_player_id` FOREIGN KEY (`player_id`) REFERENCES `persons` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-06-05 18:41:26
